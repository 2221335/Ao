...
y_train_reduced = y_train[indices_to_keep]

x_train_reduced = x_train_reduced.astype('float32') / 255.0
x_test = x_test.astype('float32') / 255.0

y_train_reduced = to_categorical(y_train_reduced, num_classes=10)
y_test = to_categorical(y_test, num_classes=10)

print("减少后的训练集形状:", x_train_reduced.shape, y_train_reduced.shape)
...
train_CNN(x_train_reduced, y_train_reduced, x_test, y_test, epochs=10, batch_size=128, seed=50)
